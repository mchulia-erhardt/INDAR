# INDAR - AMBITO EP — Especificación de implementación (Backlog + reglas + entregables)
**Fecha:** 2026-03-31  
**Objetivo del documento:** servir como **única fuente de verdad** para que **Copilot Agent (VS Code)** implemente INDAR - AMBITO EP en el repositorio de trabajo (back + front + scripts BD), apoyándose en las tablas existentes del esquema INDAR y cumpliendo las restricciones técnicas indicadas.
...
- Documentación funcional: `Análisis Funcional - INDAR - AMBITO EP_v3.md` y ASIs adjuntos (EP y piloto AT, etc.)
...
### EPIC-01 — BBDD base INDAR - AMBITO EP sobre INDAR (Oracle 10g)
